...
if i > 0:
    if ohlc_renko[ticker]["bar_num"][i] >= 2 and ohlc_renko[ticker]["macd"][i] > ohlc_renko[ticker]["macd_sig"][i] and
        ohlc_renko[ticker]["macd_slope"][i] > ohlc_renko[ticker]["macd_sig_slope"][i]:
    tickers_signal[ticker] = "Buy"
elif ohlc_renko[ticker]["bar_num"][i] <= -2 and ohlc_renko[ticker]["macd"][i] < ohlc_renko[ticker]["macd_sig"][i] and
    ohlc_renko[ticker]["macd_slope"][i] < ohlc_renko[ticker]["macd_sig_slope"][i]:
...
for ticker in tickers:
    if tickers_signal[ticker] == "":
        tickers_ret[ticker].append(0)
if ohlc_renko[ticker]["bar_num"][-1] >= 2 and ohlc_renko[ticker]["macd"][-1] > ohlc_renko[ticker]["macd_sig"][-1] and \
        ohlc_renko[ticker]["macd_slope"][i] > ohlc_renko[ticker]["macd_sig_slope"][-1]:
    tickers_signal[ticker] = "Buy"
